...
for i in range(10):
    print(f"Image {i+1:2d} | Actual: {labels[i].item()} | Predicted: {predictions[i].item()}")
...
print("1. torch.nn.Module               ✓")
print("2. Conv2d and MaxPool2d          ✓")
print("3. DataLoader                    ✓")
print("4. Dropout Regularization        ✓")
print("5. Weight Decay Regularization   ✓")
print("6. Learning Rate Scheduler       ✓")
print("7. GPU Support                   ✓")
print("8. Model Saving / Loading        ✓")
print("9. Accuracy Evaluation           ✓")
print("10. Learning Curves              ✓")
