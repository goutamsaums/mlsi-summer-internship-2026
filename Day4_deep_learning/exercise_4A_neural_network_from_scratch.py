...
5. Gradient Checking (Analytical vs Numerical)

Inspired by CS229 Deep Learning Lectures
=========================================================
"""
...
class NeuralNetwork:
    ...
    def __init__(
        ...
        self.W1 = np.random.randn(hidden1, input_size) * np.sqrt(
            1 / input_size
        )

        self.b1 = np.zeros((hidden1, 1))

        self.W2 = np.random.randn(hidden2, hidden1) * np.sqrt(
            1 / hidden1
        )

        self.b2 = np.zeros((hidden2, 1))

        self.W3 = np.random.randn(output_size, hidden2) * np.sqrt(
            1 / hidden2
        )
